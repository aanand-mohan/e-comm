        ...
        <main className="min-h-screen bg-black text-white">
            ...
            <div className="container mx-auto px-4 pb-24 max-w-7xl">
                ...
                <div className="md:hidden flex gap-4 mb-6 sticky top-16 z-30 bg-black/80 backdrop-blur-md py-2 border-b border-white/10">
                    <button className="flex-1 bg-neutral-900 border border-white/10 py-3 rounded-lg font-semibold text-gray-300 flex items-center justify-center gap-2">Filters</button>
                    <button className="flex-1 bg-neutral-900 border border-white/10 py-3 rounded-lg font-semibold text-gray-300 flex items-center justify-center gap-2">Sort By</button>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-10">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    <input
                                        type="number"
                                        placeholder="Min"
                                        className="w-full bg-black border border-white/10 rounded px-3 py-2 text-sm text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                                ...
                                <button
                                    ...
                                    className="w-full bg-white text-black py-2 rounded text-sm font-bold hover:bg-primary hover:text-white transition-colors shadow-lg"
                                >
                                    Apply
                                </button>
                            </div>
                    ...
                    <div className="flex-1">
                        ...
                        <div className="hidden md:flex justify-between items-center mb-8">
                            <p className="text-gray-400 text-sm">Showing <span className="font-bold text-primary">{filteredProducts.length}</span> results</p>
                            <div className="flex items-center gap-3">
                                <span className="text-sm text-gray-400">Sort By:</span>
                                <select
                                    value={sortBy}
                                    onChange={(e) => setSortBy(e.target.value)}
                                    className="bg-neutral-900 border border-white/10 text-gray-300 text-sm rounded-lg focus:ring-primary focus:border-primary block p-2.5 outline-none hover:border-white/30 transition-colors cursor-pointer"
                                >

        ...
        <section className="py-12 bg-black container mx-auto px-4 max-w-7xl">
            <AnimatePresence mode='wait'>
                <motion.div
                    ...
                    className="relative w-full h-[300px] md:h-[400px] rounded-2xl overflow-hidden group cursor-pointer shadow-2xl border border-white/10"
                >
                ...
                <div className="flex justify-center gap-2 mt-6">
                    {banners.map((_, idx) => (
                        <button
                            ...
                            className={`h-1.5 rounded-full transition-all duration-300 ${idx === currentIndex ? 'w-8 bg-secondary' : 'w-2 bg-gray-700 hover:bg-gray-500'
                                }`}
